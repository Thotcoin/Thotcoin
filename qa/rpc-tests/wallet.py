...
#   c) node1 mines 32 blocks, so now node 0 has 500000THOT, node 1 has 4250THOT, node2 has none.
#   d) node0 sends 601 THOT to node2, in two transactions (301 THOT, then 300 THOT).
