...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Thot features */
        {"thot", "masternode", &masternode, true, true, false},
        {"thot", "listmasternodes", &listmasternodes, true, true, false},
        {"thot", "getmasternodecount", &getmasternodecount, true, true, false},
        {"thot", "masternodeconnect", &masternodeconnect, true, true, false},
        {"thot", "masternodecurrent", &masternodecurrent, true, true, false},
        {"thot", "masternodedebug", &masternodedebug, true, true, false},
        {"thot", "startmasternode", &startmasternode, true, true, false},
        {"thot", "createmasternodekey", &createmasternodekey, true, true, false},
        {"thot", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"thot", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"thot", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"thot", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"thot", "getmasternodescores", &getmasternodescores, true, true, false},
        {"thot", "mnbudget", &mnbudget, true, true, false},
        {"thot", "preparebudget", &preparebudget, true, true, false},
        {"thot", "submitbudget", &submitbudget, true, true, false},
        {"thot", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"thot", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"thot", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"thot", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"thot", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"thot", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"thot", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"thot", "checkbudgets", &checkbudgets, true, true, false},
        {"thot", "mnsync", &mnsync, true, true, false},
        {"thot", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> thot-cli " + methodname + " " + args + "\n";
}
