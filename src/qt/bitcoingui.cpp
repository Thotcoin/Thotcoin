                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Thot Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a THOT address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and thot: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Thot Core"), this);
    aboutAction->setStatusTip(tr("Show information about Thot Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Thot"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your THOT addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified THOT addresses"));
    ...
    openAction->setStatusTip(tr("Open a thot: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Thot Core help message to get a list with possible Thot command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Thot Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Thot network", "", count));
}
...
{
    QString strTitle = tr("Thot Core"); // default title
