...
RESOURCES += src/qt/thot.qrc src/qt/thot_locale.qrc

TRANSLATIONS += src/qt/locale/thot_bg.ts \
                src/qt/locale/thot_de.ts \
                src/qt/locale/thot_en.ts \
                src/qt/locale/thot_es.ts \
                src/qt/locale/thot_fi.ts \
                src/qt/locale/thot_fr.ts \
                src/qt/locale/thot_it.ts \
                src/qt/locale/thot_ja.ts \
                src/qt/locale/thot_pl.ts \
                src/qt/locale/thot_pt.ts \
                src/qt/locale/thot_ru.ts \
                src/qt/locale/thot_sk.ts \
                src/qt/locale/thot_sv.ts \
                src/qt/locale/thot_vi.ts \
                src/qt/locale/thot_zh_CN.ts \
                src/qt/locale/thot_zh_TW.ts
