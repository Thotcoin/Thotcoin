Contributing to Thot Core
==================================

The Thot Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Thot Core project, and is not to be
confused with overall Thot Network Protocol consensus changes.

Whether a pull request is merged into Thot Core rests with the project merge
...
Patches that change Thot consensus rules are considerably more involved than
...
Where a patch set proposes to change the Thot consensus, it must have been
...
The project leader is the release manager for each Thot Core release.
