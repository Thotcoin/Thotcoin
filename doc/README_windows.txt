...
Intro
-----
Thot (THOT) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Thot utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run thot-qt.exe.

Thot Core is the original Thot client and it builds the backbone of the network.
However, it downloads and stores the entire history of Thot transactions;
