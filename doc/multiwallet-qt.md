...
In order to support loading of multiple wallets in thot-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is thot.cpp.
...
Changes to thot.cpp
----------------------
thot.cpp is the entry point into thot-qt, and as such, will require some minor modifications to provide hooks for
